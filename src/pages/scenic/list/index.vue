      ...
      <template v-if='listData.length||loading'>
        <div class="scenic-list">
          <div v-for='(item,index) in listData'
               ...
               :key='index'
               @click="goUrl('pages/scenic/detail/main?id='+item.id+'&productCode='+item.productCode)"
  ...
  .scenic-list {
    ...
    .scenic-item {
      ...
      .scenic-imgBox {
        ...
        position:relative;
        .scenic-img {
          width:120px; height:110px; position:absolute; left:0; top:0;
        }
      }
      .scenic-info {
